...
- native `builder::{revolve_path, revolve_path_region}` for exact closed
  ...
  polynomial-equivalent, rational-quadratic, and nonuniform rational line-image
  moments drive exact volume, while genuinely rational degree-three-and-higher
